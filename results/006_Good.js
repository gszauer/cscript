...
class Vector3 {
	constructor(x, y, z, debug) {
		this.x = (typeof x === "undefined")? 0 : x;
		this.y = (typeof y === "undefined")? 1.0 : y;
		this.z = (typeof z === "undefined")? 0 : z;
		this.debug = (typeof debug === "undefined")? "none" : debug;
	}
}
...
function main(args) {
	...
	let right = new Vector3(0, 0, 1);
	Vector3Cross(null, Vector3Cross(up, right));
	let numbers = [];
	let allVecs = [new Vector3(0, 1, 0), new Vector3(1, 0, 0), new Vector3(0, 1, 0), up];
	allVecs.push(new Vector3(9, 5, 9));
	allVecs.push(new Vector3(9, 5, 9));
	let allVecs1 = [up, up, null, up];
}
